...
public class SandboxMapas
{
    ...
    public List<String> getValoresComoLista( )
    {
        ...
        for (int i = 0; i < lista.size(); i++)
        {
            ...
            {
                if (lista.get(i).compareTo(lista.get(x)) > 0)
                {
    ...
    public Collection<String> getLlaves( )
    {
        ...
        {
            mayusculas.add(llaves.get(i).toUpperCase());
        }
    ...
    public int getCantidadCadenasDiferentes( )
    {
        ...
        {
            if (diferentes.contains(valores.get(i)))
            {
            }
            else
            {
                diferentes.add(valores.get(i));
            }
        }
    ...
    public void eliminarCadenaConValor( String valor )
    {
        ...
        for (int i = 0; i < llaves.size(); i++)
        {
            if (mapaCadenas.get(llaves.get(i)).equals(valor))
            {
    ...
    public void volverMayusculas( )
    {
        ...
        for (int i = 0; i < llaves.size(); i++)
        {
            valores.add(mapaCadenas.get(llaves.get(i)));
        }
        ...
        for (int i = 0; i < llaves.size(); i++)
        {
            mapaCadenas.put(llaves.get(i).toUpperCase(), valores.get(i));
        }
